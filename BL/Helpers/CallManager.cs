...
internal static class CallManager
{
    ...
    public static BO.Status GetStatus(DO.Call call)
    {
       ...
       if (call.FinishTime > AdminManager.Now && null == assignments.FirstOrDefault(a=> a.TypeOfTreatmentTermination != DO.TypeOfTreatmentTermination.SelfCancellation && a.TypeOfTreatmentTermination != DO.TypeOfTreatmentTermination.CancellationExpired))
